  ...
  return (
    <form className="call-editor" onSubmit={salvar}>
      ...
      <label className="editor-full">Descrição do chamado
        <textarea rows={5} value={form.descricao || ''} onChange={e => campo('descricao', e.target.value)} placeholder="Cole a descrição recebida para preencher os campos automaticamente" />
