...
export const modulosNexoField: ModuloNexoField[] = [
  ...
  { id: 'tecnicos', nome: 'Cadastro, pesquisa e histórico de técnicos', perfis: ['administrador'], status: 'em_migracao' },
  { id: 'logistica', nome: 'Estoque, separação, entrega e rastreamento', perfis: ['administrador', 'tecnico', 'logistica'], status: 'em_migracao' },
  { id: 'pagamentos', nome: 'Pagamentos, parceiros e exportações', perfis: ['administrador'], status: 'em_migracao' },
  { id: 'relatorios', nome: 'Relatórios operacionais e exportações', perfis: ['administrador'], status: 'em_migracao' },
  { id: 'permissoes', nome: 'Autenticação, perfis e permissões', perfis: ['administrador', 'tecnico', 'logistica'], status: 'em_migracao' },
  { id: 'aparencia', nome: 'Tema verde petróleo, azul e branco', perfis: ['administrador', 'tecnico', 'logistica'], status: 'em_migracao' },
];
