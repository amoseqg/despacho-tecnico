...
const html=fs.readFileSync('app.part3','utf8'),loader=fs.readFileSync('index.html','utf8');
assert.ok(html.includes('/release-info.js?v='+current)||loader.includes("replace('/release-info.js?v=2.0.5','/release-info.js?v='+versao)"));
